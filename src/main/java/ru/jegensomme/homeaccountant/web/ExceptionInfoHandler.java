...
import ru.jegensomme.homeaccountant.util.exception.*;

import javax.servlet.http.HttpServletRequest;
import java.util.Map;

import static ru.jegensomme.homeaccountant.util.exception.ErrorType.*;
...
public class ExceptionInfoHandler {
    ...
    public static final String EXCEPTION_DUPLICATE_DATETIME = "exception.expense.duplicateDateTime";
    ...
    private ResponseEntity<ErrorInfo> logAndGetErrorInfo(HttpServletRequest req, Exception e, boolean logStackTrace, ErrorType errorType, String... details) {
        ...
        return ResponseEntity.status(errorType.getStatus())
                .body(ErrorInfo.of(req.getRequestURL(), errorType,
