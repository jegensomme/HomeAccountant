...
public class ExpenseTestData {
    ...
    public static final Expense EXPENSE5 = new Expense(EXPENSE1_ID + 4, of(2021, Month.FEBRUARY, 27, 14, 0), 8000);
    ...
    public static final Expense ADMIN_EXPENSE3 = new Expense(ADMIN_EXPENSE1_ID + 2, of(2021, Month.FEBRUARY, 25, 14, 0), 7000);
