...
public class ExpenseTestData {
    ...
    public static Expense getNew() {
        return new Expense(null, null, of(2021, Month.JANUARY, 25, 10, 0), "10000.00", "New");
    }

    public static Expense getUpdated() {
        return new Expense(EXPENSE1_ID, USER_HOUSEHOLD, of(2021, Month.FEBRUARY, 15, 10, 0), "10000.00", "Updated");
    }
}
