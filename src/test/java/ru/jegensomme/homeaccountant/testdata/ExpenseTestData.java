...
public class ExpenseTestData {
    ...
    public static final Expense EXPENSE4 = new Expense(EXPENSE1_ID + 3, USER_HOUSEHOLD, of(2021, Month.FEBRUARY, 26, 13, 0), 9000, "Максидом");
    public static final Expense EXPENSE5 = new Expense(EXPENSE1_ID + 4, USER_HOUSEHOLD, of(2021, Month.FEBRUARY, 26, 16, 0), 4000, "Домовой");
    public static final Expense EXPENSE6 = new Expense(EXPENSE1_ID + 5, of(2021, Month.FEBRUARY, 27, 14, 0), 8000, "Потерял");
